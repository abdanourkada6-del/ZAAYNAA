...
// `title`/`onDrag*`/`onAnimationStart` are omitted from the native div
// attributes: they collide with framer-motion's own prop types (motion.section
// forwards these props) and with our custom `title: ReactNode` field.

...
export function links() {
  return [
    ...
    {rel: 'icon', type: 'image/png', href: '/zaaynaa-symbol.png'},
  ];
}
...
export const meta: Route.MetaFunction = () => {
  return [
    {title: 'ZAAYNAA — Modern Moroccan Quiet Luxury'},
    {
      name: 'description',
      content:
        "Joaillerie inspirée du Maroc, pensée à Paris. Discrète en surface, extraordinaire de près. Argent 925 & vermeil or 18k.",
    },
  ];
};

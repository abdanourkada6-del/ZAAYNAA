...
type RouteFiles = {
  "root.tsx": {
    id: "root";
    page: "/" | "/blogs/:blogHandle/:articleHandle" | "/sitemap/:type/:page.xml" | "/blogs/:blogHandle" | "/collections/:handle" | "/account/authorize" | "/collections" | "/policies/:handle" | "/products/:handle" | "/account/logout" | "/collections/all" | "/policies" | "/account/login" | "/discount/:code" | "/pages/:handle" | "/piece/:handle" | "/sitemap.xml" | "/blogs" | "/robots.txt" | "/account" | "/account/orders" | "/account/orders/:id" | "/account/addresses" | "/account/profile" | "/account/*" | "/contact" | "/search" | "/about" | "/cart" | "/cart/:lines" | "/*";
  };
  ...
  "routes/piece.$handle.tsx": {
    id: "routes/piece.$handle";
    page: "/piece/:handle";
  };
...
type RouteModules = {
  ...
  "routes/piece.$handle": typeof import("./app/routes/piece.$handle.tsx");
